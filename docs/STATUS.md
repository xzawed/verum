...
_Last updated: 2026-05-01 (PR #97/#98/#99 — SDK PR 422 수정 + `sdk_pr_requests.mode` 컬럼 추가로 Phase 0/1 상태 분리 추적, ActivationCard Phase 1 상태 DB 초기화) | Maintained by: Claude at end of each implementation session_
