...
| [7] EXPERIMENT | A/B 테스트 엔진 | 🔲 Pending | Phase 4-B |
| [8] EVOLVE | 승자 승격 자동화 | 🔲 Pending | Phase 4-B |

**Next:** Phase 4-B — EXPERIMENT + EVOLVE
...
| `apps/dashboard/src/app/repos/[id]/StagesView.tsx` | OBSERVE 섹션 마운트 (`latestDeploymentId` 존재 시) |
...
| RAGAS 평가 (faithfulness, answer_relevancy) | Phase 4-B | Phase 4-B |
| model_pricing 관리 UI | Phase 5; 현재 DB 직접 편집 | Phase 5 |
| 다중 배포 메트릭 비교 | Phase 4-B | Phase 4-B |
| 실시간 트레이스 스트리밍 (WebSocket/SSE) | Phase 5 | Phase 5 |
| EXPERIMENT / EVOLVE 로직 | 핵심 다음 목표 | Phase 4-B |
...
_Last updated: 2026-04-23 | Maintained by: Claude at end of each implementation session_
