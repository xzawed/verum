...
_Last updated: 2026-05-02 (PR #112 — Railway 플랫폼 통합 + opt-in LLM 프록시 + AES-256-GCM token 암호화 + integrations 테이블; 파일맵 신규 항목 추가) | Maintained by: Claude at end of each implementation session_
